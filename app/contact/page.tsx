              ...
              <div className="bg-[#1a2235] rounded-2xl p-6 flex flex-col gap-5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:0469370978" className="text-white font-semibold hover:text-[#FFD700] transition-colors">
                      0469 370 978
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:0451331140" className="text-white font-semibold hover:text-[#FFD700] transition-colors">
                      0451 331 140
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href="mailto:lpluspdrivingschool44@gmail.com" className="text-white hover:text-[#FFD700] transition-colors break-all">
