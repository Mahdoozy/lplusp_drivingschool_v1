export default function WhatsAppButton() {
  return (
    <a
      ...
      className="hidden md:flex fixed bottom-6 right-6 z-50 wa-pulse w-14 h-14 bg-[#22C55E] rounded-full items-center justify-center shadow-xl hover:scale-110 transition-transform"
    >
